export const profile = {
  ...
  website: "https://raahuldatta.vercel.app",
...
export const projects = [
  ...
  },
  {
    ...
    problem: "Retail traders act on news and sentiment shifts faster than they can research them.",
    approach:
  ...
  },
  {
    ...
    approach: "A Hugging Face RoBERTa model served through FastAPI, with API-key auth and LRU caching in front of it.",
    outcome:
  ...
  },
  {
    ...
    problem: "Classifying DNA sequences by species usually means picking one modeling approach and living with its limits.",
    approach:
    ...
    outcome: "A side-by-side view of how each approach performs on the same multi-species classification task.",
  ...
  },
  {
    ...
    problem: "Browsing a catalog of thousands of titles by genre alone rarely surfaces what someone actually wants to watch.",
    approach:
    ...
    outcome: "Personalized, content-based discovery instead of a static trending list.",
    stack: ["Next.js 15", "React 19", "TypeScript", "Tailwind CSS", "Redux Toolkit", "shadcn/ui"],
    domain: "Full-Stack",
  ...
  },
  {
    ...
    problem: "Family health records live scattered across paper, PDFs, and memory, especially across generations.",
    approach:
    ...
    outcome: "Centralizes family health data on-device, with ntfy notifications for anything that needs attention.",
  ...
  },
  {
    ...
    outcome: "A decoupled service architecture where each piece scales independently.",
...
export const domainOrder = ["AI Systems", "Applied ML", "Full-Stack"];
...
export const buildingNow = [
  ...
  {
    name: "Quardian",
    description: "A secure text-to-SQL desktop app with hallucination detection, schema validation, and role-based access control.",
  },
];
...
export const stack = [
  ...
  { label: "Backend & data", items: ["FastAPI", "Node.js", "Express", "PostgreSQL", "MongoDB"] },
  { label: "Cloud & tooling", items: ["AWS", "Azure", "Docker", "GitHub Actions", "Git", "Linux", "Postman"] },
];
...
export const experience = [
  {
    ...
    points: ["Incoming internship focused on CI/CD pipelines, infrastructure automation, and deployment tooling."],
...
export const achievements = [
  ...
  { label: "AWS Certified Cloud Practitioner", detail: "Certified in core AWS cloud concepts and services." },
  { label: "CGPA 8.21/10", detail: "Final-year CSE, KL University, Hyderabad — graduating 2027." },
];
